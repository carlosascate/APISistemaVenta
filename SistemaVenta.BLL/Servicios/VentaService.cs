    ...
    public class VentaService: IVentaService
    {
        ...
        public async Task<List<VentaDTO>> Historial(string buscarPor, string numeroVenta, string fechaInicio, string fechaFin)
        {
            ...
            try
            {
                if( buscarPor=="fecha")
                {
                    ...
                    ListaResultado= await query.Where(v=>v.FechaRegistro.Value.Date>=fech_Inicio.Date && v.FechaRegistro.Value.Date<=fech_Fin.Date).Include(dv=>dv.DetalleVenta)
        ...
        public async Task<List<ReporteDTO>> Reporte(string fechaInicio, string fechaFin)
        {
            ...
            try
            {
                ...
                ListaResultado=await query.Include(p=>p.IdProductoNavigation).Include(v=>v.IdVentaNavigation).Where(dv=>
